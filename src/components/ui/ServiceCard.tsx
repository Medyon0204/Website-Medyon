  ...
  return (
    ...
    >
      <Link
        href={service.href}
        className={cn(
          "group block glass-card rounded-2xl p-6 h-full transition-all duration-300",
          "hover:border-white/15 hover:shadow-[0_8px_32px_rgba(0,0,0,0.4)]",
          isMagenta
            ? "hover:shadow-[0_8px_32px_rgba(0,0,0,0.4),0_0_40px_rgba(230,0,126,0.08)]"
            : "hover:shadow-[0_8px_32px_rgba(0,0,0,0.4),0_0_40px_rgba(0,194,203,0.08)]"
        )}
      >
        {/* Icon */}
        <div
