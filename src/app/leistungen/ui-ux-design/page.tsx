  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none"
        style={{
          background: "radial-gradient(ellipse 70% 70% at 50% 50%, transparent 30%, rgba(1,10,27,0.55) 100%)",
        }}
      />
      ...
      >
        ...
        <button
          ...
          onMouseEnter={(e) => {
            ...
            el.style.borderColor = "rgba(230,0,126,0.9)";
            el.style.background = "rgba(230,0,126,0.14)";
            el.style.boxShadow = "0 0 40px rgba(230,0,126,0.35), inset 0 0 20px rgba(230,0,126,0.06)";
            el.style.color = "#ffffff";
          }}
          onMouseLeave={(e) => {
            const el = e.currentTarget;
            el.style.borderColor = "rgba(230,0,126,0.35)";
            el.style.background = "rgba(230,0,126,0.06)";
            el.style.boxShadow = "";
